...
## DUE TO THE MAGISK REPOSITORY SHUTING DOWN IF YOU WISH TO GET UPDATES FOR MY MODULE YOU'LL NEED TO USE THE FOLLOWING [APP](https://github.com/Fox2Code/FoxMagiskModuleManager/releases) AND MAKE SURE ENABLE EITHER THE ANDROIDACY OR ALT REPO
